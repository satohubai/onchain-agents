...
A daily-rendered index of what onchain AI agents are built from — 435 listings, each with a 0–100 Sato Score of how open, active and verifiable it is. Rendered 2026-09-25. Catalog data CC-BY-4.0, attribution: data by satohub.ai.
...
<sub>Highest-scored in this layer, 6 of 121. [All 121 →](categories/payments.md)</sub>
...
<sub>Highest-scored in this layer, 6 of 54. [All 54 →](categories/trading-venues.md)</sub>
