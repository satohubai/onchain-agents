...
**15 listings**, ordered by Sato Score — a 0–100 measure of how open, active and verifiable a project is, [not a safety or returns grade](../sato-score.md). Rendered 2026-09-26 from the public Sato Hub export.

| Name | What it is | Chains | ⬡ Score | Last activity | Links |
|---|---|---|---|---|---|
| [Agent Skills Hub](https://github.com/agent-skills-hub/agent-skills-hub) | A registry of AI agent skills that applies automated source-code scanning and assigns security… | — | 81 | 9 days ago | [satohub.ai](https://satohub.ai/resources/agent-skills-hub?utm_source=github&utm_medium=index&utm_campaign=onchain-agents) · [detail](../listings/agent-skills-hub.md) |
...
| [GoPlus AgentGuard](https://github.com/GoPlusSecurity/agentguard) | MIT-licensed runtime guard for AI coding agents: hook-level action blocking, a 24-rule skill… | — | 77 | 5 days ago | [satohub.ai](https://satohub.ai/resources/goplus-agentguard?utm_source=github&utm_medium=index&utm_campaign=onchain-agents) · [detail](../listings/goplus-agentguard.md) |
...
| [COTI](https://github.com/coti-io) | Privacy infrastructure that gives MCP-compatible agents private wallets, encrypted messaging, and… | COTI, Ethereum | 67 | 4 days ago | [satohub.ai](https://satohub.ai/resources/coti?utm_source=github&utm_medium=index&utm_campaign=onchain-agents) · [detail](../listings/coti.md) |
| [MistTrack MCP](https://github.com/slowmist/MistTrackMCP) | MCP server from SlowMist exposing MistTrack address risk scoring and fund-flow tracing to AI agents. | Ethereum, Bitcoin, Polygon +2 | 63 | 5 months ago | [satohub.ai](https://satohub.ai/resources/misttrack-mcp?utm_source=github&utm_medium=index&utm_campaign=onchain-agents) · [detail](../listings/misttrack-mcp.md) |
| [Usenami Signer MCP](https://github.com/namixai/signer-mcp) | MCP server that signs CEX/DEX orders inside an attested AWS Nitro Enclave so keys never touch the… | — | 61 | 12 days ago | [satohub.ai](https://satohub.ai/resources/namixai-signer-mcp?utm_source=github&utm_medium=index&utm_campaign=onchain-agents) · [detail](../listings/namixai-signer-mcp.md) |
...
| [GoPlus Security](https://github.com/GoPlusSecurity) | Keyless REST APIs for token risk, approval risk, malicious addresses, signature decoding and… | Multichain | 44 | — | [satohub.ai](https://satohub.ai/resources/goplus-security?utm_source=github&utm_medium=index&utm_campaign=onchain-agents) · [detail](../listings/goplus-security.md) |
| [Webacy](https://www.webacy.com/) | Keyed risk APIs for address, contract and transaction screening, including sanction checks, across… | Multichain | 35 | — | [satohub.ai](https://satohub.ai/resources/webacy?utm_source=github&utm_medium=index&utm_campaign=onchain-agents) · [detail](../listings/webacy.md) |
| [Honeypot.is](https://honeypot.is/) | Keyless API that simulates a buy and sell of an EVM token and reports the observed taxes, gas and… | Ethereum, BNB Chain, Base | 31 | — | [satohub.ai](https://satohub.ai/resources/honeypot-is?utm_source=github&utm_medium=index&utm_campaign=onchain-agents) · [detail](../listings/honeypot-is.md) |
| [RugCheck](https://rugcheck.xyz/) | Public Solana token-report API: mint and freeze authority, metadata mutability, LP lockers and… | Solana | 31 | — | [satohub.ai](https://satohub.ai/resources/rugcheck?utm_source=github&utm_medium=index&utm_campaign=onchain-agents) · [detail](../listings/rugcheck.md) |
...
- **GoPlus AgentGuard** — `npm install -g @goplus/agentguard`
