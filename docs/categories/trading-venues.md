...
| [Jupiter](https://github.com/jup-ag) | Solana swap aggregator that routes trades across DEXs via a widely used API and SDKs. | Solana | 84 | 3 days ago | [satohub.ai](https://satohub.ai/resources/jupiter-aggregator?utm_source=github&utm_medium=index&utm_campaign=onchain-agents) · [detail](../listings/jupiter-aggregator.md) |
| [Orca](https://github.com/orca-so/whirlpools) | Solana concentrated-liquidity AMM (Whirlpools) with open-source TypeScript and Rust SDKs. | Solana | 83 | 3 days ago | [satohub.ai](https://satohub.ai/resources/orca?utm_source=github&utm_medium=index&utm_campaign=onchain-agents) · [detail](../listings/orca.md) |
| [dYdX](https://github.com/dydxprotocol/v4-chain) | Perpetual futures DEX running on its own Cosmos SDK app-chain with REST/WebSocket and gRPC APIs. | Cosmos, Ethereum, Base +5 | 83 | 6 days ago | [satohub.ai](https://satohub.ai/resources/dydx-chain?utm_source=github&utm_medium=index&utm_campaign=onchain-agents) · [detail](../listings/dydx-chain.md) |
...
| [CloddsBot](https://github.com/alsk1992/CloddsBot) | Open-source autonomous AI trading agent operating across 1000+ markets including Polymarket… | Solana, Base, Ethereum +4 | 75 | 9 days ago | [satohub.ai](https://satohub.ai/resources/cloddsbot?utm_source=github&utm_medium=index&utm_campaign=onchain-agents) · [detail](../listings/cloddsbot.md) |
...
| [GMX](https://github.com/gmx-io) | Decentralized spot and perpetual exchange on Arbitrum and Avalanche with an official SDK and REST… | Arbitrum, Avalanche | 69 | 3 days ago | [satohub.ai](https://satohub.ai/resources/gmx?utm_source=github&utm_medium=index&utm_campaign=onchain-agents) · [detail](../listings/gmx.md) |
...
| [AgentSwap](https://github.com/agentswapco/agentswap-cli) | Non-custodial trade execution for AI agents: the agent signs, trading funds stay in the owner's… | Base, Arbitrum, BNB Chain +1 | 60 | 5 days ago | [satohub.ai](https://satohub.ai/resources/agentswap?utm_source=github&utm_medium=index&utm_campaign=onchain-agents) · [detail](../listings/agentswap.md) |
...
| [Pons](https://github.com/ponsdotdev/ponsfamily) | Permissionless fixed-supply token launchpad on Robinhood Chain, with liquidity migrated into a… | Robinhood Chain | 56 | 5 days ago | [satohub.ai](https://satohub.ai/resources/pons?utm_source=github&utm_medium=index&utm_campaign=onchain-agents) · [detail](../listings/pons.md) |
