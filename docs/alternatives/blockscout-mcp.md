---
title: "Alternatives to Blockscout MCP Server — Sato Hub index"
description: "8 alternatives to Blockscout MCP Server in the MCP layer, ordered by how open, active and verifiable each one is."
canonical: "https://satohub.ai/alternatives/blockscout-mcp"
canonical_url: "https://satohub.ai/alternatives/blockscout-mcp"
layout: "default"
page_type: "category"
item_list_name: "Alternatives to Blockscout MCP Server"
item_count: 8
...
breadcrumb:
  ...
  - name: "Alternatives to Blockscout MCP Server"
    url: "https://satohubai.github.io/onchain-agents/alternatives/blockscout-mcp"
---

# Alternatives to Blockscout MCP Server

Blockscout MCP Server sits in the **MCP** layer. These are the other scored listings in that layer, ordered by Sato Score — a 0–100 measure of how open, active and verifiable a project is, [not a safety or returns grade](../sato-score.md). Rendered 2026-09-14.
...
[Blockscout MCP Server](../listings/blockscout-mcp.md) — ⬡ 80 · [Sato Hub page ↗](https://satohub.ai/resources/blockscout-mcp?utm_source=github&utm_medium=index&utm_campaign=onchain-agents)

[Full page on satohub.ai ↗](https://satohub.ai/alternatives/blockscout-mcp?utm_source=github&utm_medium=index&utm_campaign=onchain-agents) · [← All layers](../index.md)
