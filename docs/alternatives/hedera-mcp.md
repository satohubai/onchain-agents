---
title: "Alternatives to Hedera MCP — Sato Hub index"
description: "8 alternatives to Hedera MCP in the MCP layer, ordered by how open, active and verifiable each one is."
canonical: "https://satohub.ai/alternatives/hedera-mcp"
canonical_url: "https://satohub.ai/alternatives/hedera-mcp"
layout: "default"
page_type: "category"
item_list_name: "Alternatives to Hedera MCP"
item_count: 8
...
breadcrumb:
  ...
  - name: "Alternatives to Hedera MCP"
    url: "https://satohubai.github.io/onchain-agents/alternatives/hedera-mcp"
---

# Alternatives to Hedera MCP

Hedera MCP sits in the **MCP** layer. These are the other scored listings in that layer, ordered by Sato Score — a 0–100 measure of how open, active and verifiable a project is, [not a safety or returns grade](../sato-score.md). Rendered 2026-09-14.
...
[Hedera MCP](../listings/hedera-mcp.md) — ⬡ 78 · [Sato Hub page ↗](https://satohub.ai/resources/hedera-mcp?utm_source=github&utm_medium=index&utm_campaign=onchain-agents)

[Full page on satohub.ai ↗](https://satohub.ai/alternatives/hedera-mcp?utm_source=github&utm_medium=index&utm_campaign=onchain-agents) · [← All layers](../index.md)
