---
title: "Alternatives to CoW MCP — Sato Hub index"
description: "8 alternatives to CoW MCP in the MCP layer, ordered by how open, active and verifiable each one is."
canonical: "https://satohub.ai/alternatives/cow-mcp"
canonical_url: "https://satohub.ai/alternatives/cow-mcp"
layout: "default"
page_type: "category"
item_list_name: "Alternatives to CoW MCP"
item_count: 8
...
breadcrumb:
  ...
  - name: "Alternatives to CoW MCP"
    url: "https://satohubai.github.io/onchain-agents/alternatives/cow-mcp"
---

# Alternatives to CoW MCP

CoW MCP sits in the **MCP** layer. These are the other scored listings in that layer, ordered by Sato Score — a 0–100 measure of how open, active and verifiable a project is, [not a safety or returns grade](../sato-score.md). Rendered 2026-09-14.
...
[CoW MCP](../listings/cow-mcp.md) — ⬡ 81 · [Sato Hub page ↗](https://satohub.ai/resources/cow-mcp?utm_source=github&utm_medium=index&utm_campaign=onchain-agents)

[Full page on satohub.ai ↗](https://satohub.ai/alternatives/cow-mcp?utm_source=github&utm_medium=index&utm_campaign=onchain-agents) · [← All layers](../index.md)
