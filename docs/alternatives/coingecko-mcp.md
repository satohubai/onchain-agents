---
title: "Alternatives to CoinGecko MCP — Sato Hub index"
description: "8 alternatives to CoinGecko MCP in the MCP layer, ordered by how open, active and verifiable each one is."
canonical: "https://satohub.ai/alternatives/coingecko-mcp"
canonical_url: "https://satohub.ai/alternatives/coingecko-mcp"
layout: "default"
page_type: "category"
item_list_name: "Alternatives to CoinGecko MCP"
item_count: 8
...
breadcrumb:
  ...
  - name: "Alternatives to CoinGecko MCP"
    url: "https://satohubai.github.io/onchain-agents/alternatives/coingecko-mcp"
---

# Alternatives to CoinGecko MCP

CoinGecko MCP sits in the **MCP** layer. These are the other scored listings in that layer, ordered by Sato Score — a 0–100 measure of how open, active and verifiable a project is, [not a safety or returns grade](../sato-score.md). Rendered 2026-09-14.
...
[CoinGecko MCP](../listings/coingecko-mcp.md) — ⬡ 79 · [Sato Hub page ↗](https://satohub.ai/resources/coingecko-mcp?utm_source=github&utm_medium=index&utm_campaign=onchain-agents)

[Full page on satohub.ai ↗](https://satohub.ai/alternatives/coingecko-mcp?utm_source=github&utm_medium=index&utm_campaign=onchain-agents) · [← All layers](../index.md)
