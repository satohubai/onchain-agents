---
title: "Alternatives to AIBTC MCP Server — Sato Hub index"
description: "8 alternatives to AIBTC MCP Server in the MCP layer, ordered by how open, active and verifiable each one is."
canonical: "https://satohub.ai/alternatives/aibtc-mcp"
canonical_url: "https://satohub.ai/alternatives/aibtc-mcp"
layout: "default"
page_type: "category"
item_list_name: "Alternatives to AIBTC MCP Server"
item_count: 8
...
breadcrumb:
  ...
  - name: "Alternatives to AIBTC MCP Server"
    url: "https://satohubai.github.io/onchain-agents/alternatives/aibtc-mcp"
---

# Alternatives to AIBTC MCP Server

AIBTC MCP Server sits in the **MCP** layer. These are the other scored listings in that layer, ordered by Sato Score — a 0–100 measure of how open, active and verifiable a project is, [not a safety or returns grade](../sato-score.md). Rendered 2026-09-14.
...
[AIBTC MCP Server](../listings/aibtc-mcp.md) — ⬡ 82 · [Sato Hub page ↗](https://satohub.ai/resources/aibtc-mcp?utm_source=github&utm_medium=index&utm_campaign=onchain-agents)

[Full page on satohub.ai ↗](https://satohub.ai/alternatives/aibtc-mcp?utm_source=github&utm_medium=index&utm_campaign=onchain-agents) · [← All layers](../index.md)
