---
title: "Alternatives to Raydium — Sato Hub index"
description: "8 alternatives to Raydium in the Trading Tool layer, ordered by how open, active and verifiable each one is."
canonical: "https://satohub.ai/alternatives/raydium"
canonical_url: "https://satohub.ai/alternatives/raydium"
layout: "default"
page_type: "category"
item_list_name: "Alternatives to Raydium"
item_count: 8
...
breadcrumb:
  ...
  - name: "Alternatives to Raydium"
    url: "https://satohubai.github.io/onchain-agents/alternatives/raydium"
---

# Alternatives to Raydium

Raydium sits in the **Trading Tool** layer. These are the other scored listings in that layer, ordered by Sato Score — a 0–100 measure of how open, active and verifiable a project is, [not a safety or returns grade](../sato-score.md). Rendered 2026-09-14.
...
[Raydium](../listings/raydium.md) — ⬡ 95 · [Sato Hub page ↗](https://satohub.ai/resources/raydium?utm_source=github&utm_medium=index&utm_campaign=onchain-agents)

[Full page on satohub.ai ↗](https://satohub.ai/alternatives/raydium?utm_source=github&utm_medium=index&utm_campaign=onchain-agents) · [← All layers](../index.md)
