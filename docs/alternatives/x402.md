---
title: "Alternatives to x402 — Sato Hub index"
description: "8 alternatives to x402 in the API / SDK layer, ordered by how open, active and verifiable each one is."
canonical: "https://satohub.ai/alternatives/x402"
canonical_url: "https://satohub.ai/alternatives/x402"
layout: "default"
page_type: "category"
item_list_name: "Alternatives to x402"
item_count: 8
...
breadcrumb:
  ...
  - name: "Alternatives to x402"
    url: "https://satohubai.github.io/onchain-agents/alternatives/x402"
---

# Alternatives to x402

x402 sits in the **API / SDK** layer. These are the other scored listings in that layer, ordered by Sato Score — a 0–100 measure of how open, active and verifiable a project is, [not a safety or returns grade](../sato-score.md). Rendered 2026-09-16.
...
[x402](../listings/x402.md) — ⬡ 86 · [Sato Hub page ↗](https://satohub.ai/resources/x402?utm_source=github&utm_medium=index&utm_campaign=onchain-agents)

[Full page on satohub.ai ↗](https://satohub.ai/alternatives/x402?utm_source=github&utm_medium=index&utm_campaign=onchain-agents) · [← All layers](../index.md)
