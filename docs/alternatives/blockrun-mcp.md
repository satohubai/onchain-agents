---
title: "Alternatives to BlockRun MCP — Sato Hub index"
description: "8 alternatives to BlockRun MCP in the MCP layer, ordered by how open, active and verifiable each one is."
canonical: "https://satohub.ai/alternatives/blockrun-mcp"
canonical_url: "https://satohub.ai/alternatives/blockrun-mcp"
layout: "default"
page_type: "category"
item_list_name: "Alternatives to BlockRun MCP"
item_count: 8
...
breadcrumb:
  ...
  - name: "Alternatives to BlockRun MCP"
    url: "https://satohubai.github.io/onchain-agents/alternatives/blockrun-mcp"
---

# Alternatives to BlockRun MCP

BlockRun MCP sits in the **MCP** layer. These are the other scored listings in that layer, ordered by Sato Score — a 0–100 measure of how open, active and verifiable a project is, [not a safety or returns grade](../sato-score.md). Rendered 2026-09-14.
...
[BlockRun MCP](../listings/blockrun-mcp.md) — ⬡ 89 · [Sato Hub page ↗](https://satohub.ai/resources/blockrun-mcp?utm_source=github&utm_medium=index&utm_campaign=onchain-agents)

[Full page on satohub.ai ↗](https://satohub.ai/alternatives/blockrun-mcp?utm_source=github&utm_medium=index&utm_campaign=onchain-agents) · [← All layers](../index.md)
