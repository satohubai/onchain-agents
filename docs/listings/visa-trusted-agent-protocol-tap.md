...
> Sato Hub. *Onchain Agents index* (dataset, CC-BY-4.0), entry `visa-trusted-agent-protocol-tap`. https://satohub.ai/resources/visa-trusted-agent-protocol-tap — retrieved 2026-09-15.
