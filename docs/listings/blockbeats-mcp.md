...
- Live endpoint probed by us: 59.4% of our checks succeeded over 64 days. That is a success rate of our checks, not the project's uptime.
...
> Sato Hub. *Onchain Agents index* (dataset, CC-BY-4.0), entry `blockbeats-mcp`. https://satohub.ai/resources/blockbeats-mcp — retrieved 2026-09-16.
