...
> Sato Hub. *Onchain Agents index* (dataset, CC-BY-4.0), entry `agent-payments-protocol-ap2`. https://satohub.ai/resources/agent-payments-protocol-ap2 — retrieved 2026-09-23.
