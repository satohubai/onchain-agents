...
- Live endpoint probed by us: 65.3% of our checks succeeded over 72 days. That is a success rate of our checks, not the project's uptime.
...
> Sato Hub. *Onchain Agents index* (dataset, CC-BY-4.0), entry `santiment-mcp`. https://satohub.ai/resources/santiment-mcp — retrieved 2026-09-24.
