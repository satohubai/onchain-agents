...
- Live endpoint probed by us: 94.2% of our checks succeeded over 69 days. That is a success rate of our checks, not the project's uptime.
...
> Sato Hub. *Onchain Agents index* (dataset, CC-BY-4.0), entry `orderly-network`. https://satohub.ai/resources/orderly-network — retrieved 2026-09-21.
