...
- **Chains:** Base
- **Interfaces:** ui
- **Use cases:** payments, wallets, security
- **Open source:** Partial
- **Status:** Unknown
...
[Website](https://freysa.ai) · [Sato Hub page ↗](https://satohub.ai/resources/freysa?utm_source=github&utm_medium=index&utm_campaign=onchain-agents)

## Cite

> Sato Hub. *Onchain Agents index* (dataset, CC-BY-4.0), entry `freysa`. https://satohub.ai/resources/freysa — retrieved 2026-09-23.
