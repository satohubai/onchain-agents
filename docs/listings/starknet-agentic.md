...
- Live endpoint probed by us: 0% of our checks succeeded over 60 days. That is a success rate of our checks, not the project's uptime.
...
> Sato Hub. *Onchain Agents index* (dataset, CC-BY-4.0), entry `starknet-agentic`. https://satohub.ai/resources/starknet-agentic — retrieved 2026-09-17.
