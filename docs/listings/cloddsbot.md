...
Sato Score: **⬡ 75** (High), +1 over 7 days — a measure of how open, active and verifiable this project is, [not a safety or returns grade](../sato-score.md).

## Facts

- **Category:** Trading Tool
- **Chains:** Solana, Base, Ethereum, Arbitrum, Optimism, Polygon, Hyperliquid
- **Interfaces:** cli
- **Use cases:** trading
- **Creator:** alsk1992
- **Open source:** Yes
...
[Website](https://www.cloddsbot.com) · [GitHub](https://github.com/alsk1992/CloddsBot) · [Sato Hub page ↗](https://satohub.ai/resources/cloddsbot?utm_source=github&utm_medium=index&utm_campaign=onchain-agents)

## Cite

> Sato Hub. *Onchain Agents index* (dataset, CC-BY-4.0), entry `cloddsbot`. https://satohub.ai/resources/cloddsbot — retrieved 2026-09-15.
