...
- Live endpoint probed by us: 83.3% of our checks succeeded over 66 days. That is a success rate of our checks, not the project's uptime.
...
> Sato Hub. *Onchain Agents index* (dataset, CC-BY-4.0), entry `printr`. https://satohub.ai/resources/printr — retrieved 2026-09-23.
