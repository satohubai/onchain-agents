...
- Live endpoint probed by us: 49.2% of our checks succeeded over 63 days. That is a success rate of our checks, not the project's uptime.
...
> Sato Hub. *Onchain Agents index* (dataset, CC-BY-4.0), entry `hive-intelligence-mcp`. https://satohub.ai/resources/hive-intelligence-mcp — retrieved 2026-09-15.
