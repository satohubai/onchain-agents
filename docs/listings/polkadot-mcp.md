...
- Live endpoint probed by us: 31.3% of our checks succeeded over 67 days. That is a success rate of our checks, not the project's uptime.
...
> Sato Hub. *Onchain Agents index* (dataset, CC-BY-4.0), entry `polkadot-mcp`. https://satohub.ai/resources/polkadot-mcp — retrieved 2026-09-19.
