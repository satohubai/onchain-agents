...
- Live endpoint probed by us: 38% of our checks succeeded over 71 days. That is a success rate of our checks, not the project's uptime.
...
> Sato Hub. *Onchain Agents index* (dataset, CC-BY-4.0), entry `drpc-agent-skills`. https://satohub.ai/resources/drpc-agent-skills — retrieved 2026-09-23.
