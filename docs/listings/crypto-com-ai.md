...
Sato Score: **⬡ 81** (High), +20 over 7 days — a measure of how open, active and verifiable this project is, [not a safety or returns grade](../sato-score.md).
...
> Sato Hub. *Onchain Agents index* (dataset, CC-BY-4.0), entry `crypto-com-ai`. https://satohub.ai/resources/crypto-com-ai — retrieved 2026-09-23.
