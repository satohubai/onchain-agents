...
> Sato Hub. *Onchain Agents index* (dataset, CC-BY-4.0), entry `memecoin-observatory-mcp`. https://satohub.ai/resources/memecoin-observatory-mcp — retrieved 2026-09-14.
