...
- Live endpoint probed by us: 95.2% of our checks succeeded over 63 days. That is a success rate of our checks, not the project's uptime.
...
> Sato Hub. *Onchain Agents index* (dataset, CC-BY-4.0), entry `a0x`. https://satohub.ai/resources/a0x — retrieved 2026-09-15.
