...
- Live endpoint probed by us: 90.4% of our checks succeeded over 73 days. That is a success rate of our checks, not the project's uptime.
...
> Sato Hub. *Onchain Agents index* (dataset, CC-BY-4.0), entry `coinbase-mcp`. https://satohub.ai/resources/coinbase-mcp — retrieved 2026-09-26.
