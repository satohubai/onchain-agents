...
Sato Score: **⬡ 87** (High), +8 over 7 days — a measure of how open, active and verifiable this project is, [not a safety or returns grade](../sato-score.md).
...
> Sato Hub. *Onchain Agents index* (dataset, CC-BY-4.0), entry `bankr`. https://satohub.ai/resources/bankr — retrieved 2026-09-21.
