...
- **Category:** MCP
- **Chains:** Base, Polygon, Avalanche, Sei
- **Open source:** Unknown
- **Status:** Early

## What we checked

- Live endpoint probed by us: 89.5% of our checks succeeded over 57 days. That is a success rate of our checks, not the project's uptime.
- Verification status: **Unverified**. Self-reported is not verified, and nothing here is a safety, quality or returns claim.

## Links

[Website](https://network.mercury-hq.com) · [Sato Hub page ↗](https://satohub.ai/resources/mercury-x402-mcp?utm_source=github&utm_medium=index&utm_campaign=onchain-agents)

## Cite

> Sato Hub. *Onchain Agents index* (dataset, CC-BY-4.0), entry `mercury-x402-mcp`. https://satohub.ai/resources/mercury-x402-mcp — retrieved 2026-09-14.
