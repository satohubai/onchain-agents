...
- Live endpoint probed by us: 77.6% of our checks succeeded over 58 days. That is a success rate of our checks, not the project's uptime.
...
> Sato Hub. *Onchain Agents index* (dataset, CC-BY-4.0), entry `clawnch`. https://satohub.ai/resources/clawnch — retrieved 2026-09-15.
