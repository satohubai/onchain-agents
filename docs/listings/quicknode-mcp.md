...
Sato Score: **⬡ 35** (Low), -4 over 7 days — a measure of how open, active and verifiable this project is, [not a safety or returns grade](../sato-score.md).
...
> Sato Hub. *Onchain Agents index* (dataset, CC-BY-4.0), entry `quicknode-mcp`. https://satohub.ai/resources/quicknode-mcp — retrieved 2026-09-23.
