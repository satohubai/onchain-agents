...
- Live endpoint probed by us: 97.2% of our checks succeeded over 72 days. That is a success rate of our checks, not the project's uptime.
...
> Sato Hub. *Onchain Agents index* (dataset, CC-BY-4.0), entry `haiku-defi-mcp`. https://satohub.ai/resources/haiku-defi-mcp — retrieved 2026-09-24.
