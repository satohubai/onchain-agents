...
- Live endpoint probed by us: 97.1% of our checks succeeded over 70 days. That is a success rate of our checks, not the project's uptime.
...
> Sato Hub. *Onchain Agents index* (dataset, CC-BY-4.0), entry `kraken-cli`. https://satohub.ai/resources/kraken-cli — retrieved 2026-09-23.
