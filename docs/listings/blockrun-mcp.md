...
Sato Score: **⬡ 89** (High) — a measure of how open, active and verifiable this project is, [not a safety or returns grade](../sato-score.md).
...
> Sato Hub. *Onchain Agents index* (dataset, CC-BY-4.0), entry `blockrun-mcp`. https://satohub.ai/resources/blockrun-mcp — retrieved 2026-09-16.
