...
<picture>
  ...
  <img src="assets/statband-light.svg" alt="369 resources · 29 chains · 366 scored · 129 independently checked · updated 2026-07-20" width="760">
</picture>
**366 scored** (evidence-only Sato Score, every product) · **129 independently checked ✓** (62 installs reproduced in isolated containers, 36 evidence-reviewed, 31 live endpoints probed) — and growing.
...
| [Gloria MCP](https://github.com/cryptobriefing/gloria-mcp) | MCP server for Gloria AI's curated crypto news feed — sentiment-tagged headlines, recaps, and search for… | Base | [⬡ 35](https://satohub.ai/resources/gloria-mcp?utm_source=github&utm_medium=index&utm_campaign=onchain-agents) | 🟠 Quiet | ★ 0 |  |
...
- ⬆ **+40** [Pyth MCP](https://satohub.ai/resources/pyth-mcp?utm_source=github&utm_medium=index&utm_campaign=onchain-agents) — 22 → 62
...
- **[Self Protocol](https://satohub.ai/resources/self-protocol?utm_source=github&utm_medium=index&utm_campaign=onchain-agents)** (Security Tool) — Open-source zero-knowledge identity protocol (passport-based proof of personhood) used to gate agent access…
...
- **[PaladinFi Swap MCP](https://satohub.ai/resources/paladinfi-swap-mcp?utm_source=github&utm_medium=index&utm_campaign=onchain-agents)** (Trading Tool) — MCP-native swap router on Base querying 0x and Velora in parallel, with a built-in risk-screen tool.
- **[Bitrefill](https://satohub.ai/resources/bitrefill?utm_source=github&utm_medium=index&utm_campaign=onchain-agents)** (API / SDK) — Crypto-to-gift-card and mobile top-up commerce platform with a Skills/MCP/API surface for agents to buy…
...
- **[Mercury x402 MCP](https://satohub.ai/resources/mercury-x402-mcp?utm_source=github&utm_medium=index&utm_campaign=onchain-agents)** (MCP) — Pay-per-call MCP server (x402, USDC on Base) offering keyless web-read, structured extraction, and markdown…
...
- **[EruditePay Blockchain Intelligence](https://satohub.ai/resources/eruditepay-blockchain-intelligence?utm_source=github&utm_medium=index&utm_campaign=onchain-agents)** (Data Tool) — Pay-per-call MCP for blockchain analytics — gas tracking, whale monitoring, wallet profiling — spanning Base…
