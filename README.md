...
<picture>
  ...
  <img src="assets/statband-light.svg" alt="369 resources · 29 chains · 366 scored · 135 independently checked · updated 2026-08-21" width="760">
</picture>
**366 scored** (evidence-only Sato Score, every product) · **135 independently checked ✓** (62 installs reproduced in isolated containers, 36 evidence-reviewed, 36 live endpoints probed) — and growing.
...
- ⬆ **+37** [Hive Intelligence Crypto MCP](https://satohub.ai/resources/hive-intelligence-mcp?utm_source=github&utm_medium=index&utm_campaign=onchain-agents) — 25 → 62
...
- ⬆ **+12** [Orderly Network](https://satohub.ai/resources/orderly-network?utm_source=github&utm_medium=index&utm_campaign=onchain-agents) — 57 → 69
...
- ⬇ **-10** [MetaMask Skills](https://satohub.ai/resources/metamask-skills?utm_source=github&utm_medium=index&utm_campaign=onchain-agents) — 62 → 52
...
<sub>Maintained by [Sato Hub](https://satohub.ai?utm_source=github&utm_medium=index&utm_campaign=onchain-agents) — the agent builder hub for crypto. Index auto-rendered daily from the public export (`https://satohub.ai/api/export/index.json`). Catalog data **CC-BY-4.0** (attribution: *data by satohub.ai*); tooling **MIT © Prime Signal LLC**. Scores and liveness are informational signals, not endorsements or financial advice ([NEUTRALITY.md](NEUTRALITY.md) · [cite this dataset](CITATION.cff)). Last render: 2026-08-21.</sub>
