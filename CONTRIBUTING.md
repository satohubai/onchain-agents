...
**Prefer a PR?** Add `proposals/<slug>.json` (schema + template in [`proposals/`](proposals/README.md)) and open a pull request. Once merged, a weekly job picks it up. Issue form or PR — both land in the Sato Hub review inbox; nothing is listed automatically, and nobody comments on the ticket until a human has looked.
