...
export function renderStatBand({ entries, scored, verified, date, variant = "dark" }) {
  ...
  return `<svg xmlns="http://www.w3.org/2000/svg" width="${W}" height="${H}" viewBox="0 0 ${W} ${H}" role="img" aria-label="${entries} entries, ${scored} scored, ${verified} verified installs, updated ${date}">
${cells}
</svg>
`;
}
